...
class TextDataset:
    ...
    def __init__(self, args, base_attrs):
        ...
        # 텍스트 백본이 'bert'로 시작하는 경우 텍스트 피처를 생성합니다.
    ...
    def _get_bert_feats(self, args, examples, base_attrs):
        ...
        # sample들을 BERT 피처로 변환
        # examples = [InputExample(guid=guid, text_a=text_a, text_b=None)]
...
class DatasetProcessor(DataProcessor):
    # mode[train, dev, test]각각 처리하기 위한 클래스
...
def _truncate_seq_pair(tokens_a, tokens_b, max_length):
    ...
    # 쉽게 설명하면 text_a와 text_b를 붙일 때 max_length를 넘어가면 text_a를 자르는 것
    # TODO: toekn_b가 None인지 확인 필요
    while True:
